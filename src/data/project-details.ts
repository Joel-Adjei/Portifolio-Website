...
export const projectDetails: Record<string, Project> = {
  "1": {
    ...
    date: "2024-01-15",
    videoUrl: "https://youtu.be/ynPJNxFIJh4?si=-jdqEWIU3CPIZTJD",
  ...
  "6": {
    ...
    description:
      "Complete brand identity package including logo design, color palette, typography, and brand guidelines for a modern tech startup.",
    longDescription:
